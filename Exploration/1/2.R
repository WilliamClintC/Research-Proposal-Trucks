...
process_data <- function(file_path, output_prefix, plot_label) {
  ...
  df <- dplyr::mutate(
    df,
    interaction_2002_2006 = INJURIES * indicator_2002_2006,
    interaction_1999_2001 = INJURIES * indicator_1999_2001,
    interaction_1993_1998 = INJURIES * indicator_1993_1998
  )
