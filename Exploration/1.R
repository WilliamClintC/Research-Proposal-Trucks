...
stargazer(model1, model2, model3, type = "html", title = "Linear Model Summary", 
          column.labels = c("Unconditioned", "Conditional on More Than 2 Truck Stops Created", "Conditional on More Than 1 Truck Stops Created"), 
